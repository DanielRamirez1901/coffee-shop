...
public class LoginScreenController implements Initializable {
    ...
    public void initializeTableViewClients() {
        ...
        tableClientsNumber.setCellValueFactory(new PropertyValueFactory<Client, Integer>("NÂ°"));//the tableview 
        ...
        tableAddressClient.setCellValueFactory(new PropertyValueFactory<Client, String>("DirecciÃ³n"));//the tableview search for a method called getDirection
        tablePhoneClient.setCellValueFactory(new PropertyValueFactory<Client, String>("TelÃ©fono"));//the tableview search for a method called getPhone
    }
    ...
    public void initializeTableViewProducts() {
        ...
        tableProductSize.setCellValueFactory(new PropertyValueFactory<Product, String>("TamaÃ±o"));//the tableview search for a method called getDirection
